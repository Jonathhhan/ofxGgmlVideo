...
try {
	...
	Assert-FileContains $releaseNotes "OFXGGML_VIDEO_VERSION_STRING.*1\.0\.1" "v1.0.1 release notes"
	Assert-FileContains $releaseNotes "does not include a complete video understanding" "v1.0.1 release notes"
