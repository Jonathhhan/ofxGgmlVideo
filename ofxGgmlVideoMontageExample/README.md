...
windows, sampled frame references, ordered montage segments, and timeline
duration. It also displays a deterministic edit-decision-list text handoff that
an app can save or translate into a richer project format, plus a compact
machine-readable manifest for agents, tests, and bridge tools.
